...
export default function LogIn(props: ModalProps) {
	return (
		<Modal {...props} size='lg' aria-labelledby='login-form' centered className='text myModals'>
			<Modal.Header className='modalHead' closeButton>
				<Modal.Title className='fontBold'>Log In</Modal.Title>
			</Modal.Header>
			<Modal.Body className='modalBody'>
				<h6 className='font'>
					Please Note: This login form is only for the owner of this site.
				</h6>
				<hr />
				<Formik
